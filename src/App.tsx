...
const MODELS: Model[] = [
  {
    ...
    badge: 'BESTSELLER',
    badgeStyle: 'bg-stone-600 text-stone-100',
    accent: '#c4a96a',
...
export default function App() {
  ...
  return (
    <div className="min-h-screen bg-[#040406] text-[#f2ede6] overflow-x-hidden" style={{ fontFamily: "'DM Sans', sans-serif" }}>
      ...
      <div className="fixed inset-0 pointer-events-none z-0 overflow-hidden">
        <div className="absolute -top-32 -left-32 w-[700px] h-[700px] rounded-full bg-[#c4a96a]/[0.025] blur-[160px]" />
        <div className="absolute top-1/2 -right-40 w-[500px] h-[500px] rounded-full bg-white/[0.012] blur-[140px]" />
        <div className="absolute bottom-0 left-1/3 w-[400px] h-[400px] rounded-full bg-[#c4a96a]/[0.015] blur-[120px]" />
      ...
      <header className={`fixed top-0 inset-x-0 z-50 transition-all duration-500 ${scrolled ? 'py-3 glass backdrop-blur-xl !border-0' : 'py-5 bg-transparent'}`}>
        <div className="max-w-7xl mx-auto px-5 sm:px-8 flex items-center justify-between">
          ...
          <a href="#home" className="flex items-center gap-3 group">
            <div className="relative w-10 h-10 rounded-xl bg-gradient-to-br from-stone-600 to-stone-800 flex items-center justify-center glow-vio group-hover:scale-105 transition-transform">
          ...
          <div className="grid lg:grid-cols-[1fr_420px] xl:grid-cols-[1fr_500px] gap-12 lg:gap-8 items-center">
            ...
            <div>
              ...
              <div className="inline-flex items-center gap-2.5 px-4 py-2 rounded-full border-run mb-8 anim-fadeup">
                <span className="w-2 h-2 rounded-full bg-[#c4a96a] flex-shrink-0" />
                <span className="lbl text-[#c4a96a]">Open Order — Produksi 48 Jam</span>
              </div>
              ...
              <h1 className="font-black leading-[.9] tracking-tight mb-7"
                ...
                <span className="block text-white italic">IMPIANMU<span className="text-[#c4a96a]">.</span></span>
              </h1>
            ...
            <div className="relative flex items-center justify-center h-[480px] lg:h-[580px]">
              {/* Orbit rings */}
              <div className="absolute w-[420px] h-[420px] rounded-full border border-white/[0.05] anim-spin-cw" />
              <div className="absolute w-[320px] h-[320px] rounded-full border border-white/[0.04] anim-spin-ccw" />

              {/* Central glow */}
              <div className="absolute w-72 h-72 rounded-full bg-white/[0.025] blur-3xl" />

              {/* Hero image card */}
              <div className="relative anim-float-a z-10">
                <div className="w-60 h-72 sm:w-72 sm:h-[340px] rounded-[28px] overflow-hidden border border-white/10 bg-white/[0.03]">
                  <img src="https://images.unsplash.com/photo-1759885697855-52d11c41b19b?w=600&h=700&fit=crop&auto=format"
                    alt="Premium 3D robot figure"
                ...
                <div className="absolute -bottom-5 left-1/2 -translate-x-1/2 glass-vio rounded-2xl px-5 py-3 text-center whitespace-nowrap glow-vio">
                  <div className="lbl text-[#c4a96a] mb-0.5">Mech Warrior Custom</div>
              ...
              <div className="absolute bottom-16 -left-4 sm:left-0 anim-float-b z-20" style={{ animationDelay: '2.5s' }}>
                <div className="glass-vio rounded-2xl px-4 py-3">
                  <div className="flex gap-0.5 text-[#c4a96a] text-xs mb-1">★★★★★</div>
      ...
      {/* ════════════ TICKER ═════════════════════════════ */}
      <div className="relative z-10 border-y border-white/[0.06] py-4 overflow-hidden bg-white/[0.02]">
        <div className="flex anim-marquee whitespace-nowrap will-change-transform">
          {ticker.map((t, i) => (
            <span key={i} className="lbl text-white/30 mx-8 flex-shrink-0">{t}</span>
          ))}
        </div>
      </div>
        ...
        <div className="max-w-7xl mx-auto px-5 sm:px-8">
              ...
              {CATS.map(c => (
                <button key={c} onClick={() => setCat(c)}
                  className={`px-5 py-2 rounded-xl text-sm font-semibold transition-all duration-300 lbl ${
                    cat === c
                      ? 'bg-[#c4a96a] text-[#0b0b0f] scale-105'
                      : 'glass text-white/40 hover:text-white hover:border-white/15'
                  }`}>
                  {c}
                </button>
              ))}
              ...
              <FadeUp key={m.id} delay={i * 70}>
                <article className="glass border border-white/6 rounded-[28px] overflow-hidden card-lift flex flex-col h-full">
                  ...
                  <div className="relative h-60 overflow-hidden flex-shrink-0 bg-zinc-900">
                    ...
                    <div className="absolute inset-0 bg-gradient-to-t from-[#0b0b0f] via-[#07070e]/20 to-transparent" />
                  ...
                  <div className="p-5 flex flex-col flex-1">
                    ...
                    <div className="flex items-center justify-between mb-5">
                      ...
                      <div className="glass border border-white/8 rounded-xl px-3 py-1.5 flex items-center gap-1.5 text-xs text-white/40">
                        <span className="w-1.5 h-1.5 rounded-full bg-[#c4a96a]" />
                        Ready
                      </div>
                    </div>
          ...
          <FadeUp delay={200} className="mt-14 text-center">
            <a href="https://shopee.co.id" target="_blank" rel="noopener noreferrer"
              className="inline-flex items-center gap-3 px-10 py-4 rounded-2xl glass border border-white/10 text-white/60 hover:text-white hover:border-white/20 transition-all hover:-translate-y-1 font-semibold">
              <IcoShopee />
            ...
            {STEPS.map((s, i) => (
              <FadeUp key={s.n} delay={i * 110}>
                <div className="glass border border-white/6 rounded-[24px] p-6 card-lift relative overflow-hidden">
                  ...
                  <div className="w-12 h-12 rounded-2xl bg-gradient-to-br from-white/5 to-white/[0.02] border border-white/10 flex items-center justify-center mb-5">
        ...
        <div className="max-w-5xl mx-auto px-5 sm:px-8">
          <FadeUp>
            <div className="relative rounded-[32px] overflow-hidden">
              ...
              <div className="absolute inset-0 bg-gradient-to-r from-[#0b0b0f]/95 via-[#0b0b0f]/80 to-[#0b0b0f]/95" />
          ...
          <FadeUp className="mb-16">
            <div className="flex flex-col lg:flex-row lg:items-end justify-between gap-6">
              ...
              <div className="glass-vio rounded-2xl px-7 py-5 text-center min-w-[160px]">
                ...
                <div className="flex justify-center gap-0.5 text-[#c4a96a] text-lg mb-1">★★★★★</div>
                ...
                <FadeUp key={r.id} delay={i * 60}>
                  <div className="glass border border-white/6 rounded-[22px] p-5 card-lift">
                    <div className="flex items-start gap-4">
                      {/* Avatar */}
                      <div className="w-11 h-11 rounded-2xl bg-gradient-to-br from-stone-600 to-stone-800 flex items-center justify-center flex-shrink-0 text-white font-bold text-sm lbl">
                        {r.avatar}
                      </div>
                      <div className="flex-1 min-w-0">
                        ...
                        <div className="flex gap-0.5 mb-2">
                          {[1,2,3,4,5].map(s => (
                            <span key={s} className={`text-sm ${s <= r.rating ? 'text-[#c4a96a]' : 'text-white/15'}`}>★</span>
                          ))}
                        </div>
                        {/* Product tag */}
                        <span className="inline-block lbl text-[#c4a96a] text-[9px] bg-white/5 border border-white/10 rounded-full px-2.5 py-1 mb-2">
                          {r.product}
                        </span>
                  ...
                  <form onSubmit={submitReview} className="space-y-4">
                    ...
                    <div className="grid grid-cols-2 gap-3">
                      <div>
                        ...
                        <input
                          ...
                          required
                          className="w-full bg-white/5 border border-white/10 rounded-xl px-4 py-3 text-sm text-white placeholder-white/25 outline-none focus:border-white/25 focus:bg-white/[0.03] transition-all"
                        />
                      </div>
                      <div>
                    ...
                    <div>
                      ...
                      <select
                        ...
                        className="w-full bg-[#06060a] border border-white/10 rounded-xl px-4 py-3 text-sm text-white/80 outline-none focus:border-white/25 transition-all appearance-none cursor-pointer"
                      >
                    ...
                    <div>
                      ...
                      <div className="flex gap-2">
                        {[1,2,3,4,5].map(s => (
                          ...
                          >
                            <span className={s <= (hoverStar || form.rating) ? 'text-[#c4a96a]' : 'text-white/15'}>★</span>
                          </button>
                        ))}
                    ...
                    <div>
                      ...
                      <textarea
                        ...
                        required
                        rows={4}
                        className="w-full bg-white/5 border border-white/10 rounded-xl px-4 py-3 text-sm text-white placeholder-white/25 outline-none focus:border-white/25 focus:bg-white/[0.03] transition-all resize-none"
                      />
                    </div>
          ...
          <div className="grid sm:grid-cols-2 lg:grid-cols-[2fr_1fr_1fr_1.2fr] gap-12 mb-14">
            ...
            <div>
              <div className="flex items-center gap-3 mb-5">
                <div className="w-10 h-10 rounded-xl bg-gradient-to-br from-stone-600 to-stone-800 flex items-center justify-center glow-vio">
                  <span className="text-white font-black text-xs" style={{ fontFamily: "'JetBrains Mono',monospace" }}>3D</span>
                </div>
                <div>
